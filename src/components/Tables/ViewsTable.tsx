...
type StandardHeaders = {
  [key in 'title' | 'user' | 'organisation' | 'community' | 'created_on' | 'url' ] : Header
}

export default function ViewsTable({ title, headers, rows, loading_message = 'Data is loading'}: CollabsTableProps){
  const standard_headers: StandardHeaders = {
    ...
    created_on: {label: 'Viewed', field: 'created_on', size: 'w-[120px]'},
