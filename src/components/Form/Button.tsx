...
export default function Button({onClick, children, type = "button", variant = 'primary'}: ButtonProps) {
  ...
  return (
    <button onClick={handleClick} type={type} className={'px-2 h-[36px] min-w-[100px] rounded whitespace-nowrap relative focus:outline-none focus:ring-4 gap-1.5 border font-medium transition-colors duration-300 flex items-center justify-center ' + buttonClasses[variant]}>
